...
export const ChatSidebar: React.FC<ChatSidebarProps> = ({ onNodeClick }) => {
  ...
  return (
    <div className="w-[350px] h-full flex flex-col bg-surface-container-lowest border-l border-whisper-border shrink-0 transition-all duration-300 ease-in-out">
      ...
      <div className="h-12 border-b border-whisper-border flex items-center justify-between px-4 shrink-0 bg-surface-container/50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-sm text-on-surface tracking-wide">O.R.I.O.N.</span>
        </div>
